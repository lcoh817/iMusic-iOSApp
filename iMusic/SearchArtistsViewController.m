...
- (void)viewDidLoad {
	...
	/* Create an instance of MusicStoreService */
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar {
	...
	// Look up the artist by making an API call to iTunes
    [self.service findArtistsByArtistName:searchBar.text completionBlock:^(id result, NSError *error) {
		...
		// Set the artists property to the result paramater of the search
		self.artists = result;
